...
/** 点击确定 */
@property (nullable, nonatomic, copy) void(^confirmClick)(void);
/** 点击中间按钮 */
@property (nullable, nonatomic, copy) void(^centerClick)(void);
/** 点击取消按钮 */
@property (nullable, nonatomic, copy) void(^cancelClick)(void);
...
/**
 app默认的两种弹窗
 */
- (nullable instancetype)initWithPopStyle:(ZJAnimationPopStyle)popStyle
                                 dismissStyle:(ZJAnimationDismissStyle)dismissStyle;
...
/**
 显示输入弹窗
 */
- (void)popInputAlertWithTitle:(NSString *_Nonnull)title placeholder:(NSString *_Nonnull)placeholder;
/** 点击确定 */
@property (nullable, nonatomic, copy) void(^inputViewBlock)(NSString *str);
