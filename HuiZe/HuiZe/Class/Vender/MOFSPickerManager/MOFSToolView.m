...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _ivBlue = [[UIView alloc] initWithFrame:CGRectMake(15, 18, 4, 14)];
        _ivBlue.backgroundColor = ColorS(COLOR_BG_2E86FF);
        [self addSubview:_ivBlue];
        
        _cancelBar = [UILabel new];
        _cancelBar.font = [UIFont systemFontOfSize:14];
        _cancelBar.textColor = BAR_COLOR;
        _cancelBar.text = @"取消";
        _cancelBar.hidden = YES;
        ...
        _titleBar = [[UILabel alloc] initWithFrame:CGRectMake(27, 15, 200, 21)];
        _titleBar.font = [UIFont systemFontOfSize:14];
        _titleBar.textColor = ColorS(COLOR_414141);
        ...
        _commitBar = [[UILabel alloc] initWithFrame:CGRectMake(HUZSCREEN_WIDTH-46, 15, 31, 21)];
        _commitBar.font = [UIFont systemFontOfSize:14];
        _commitBar.textColor = ColorS(COLOR_2E86FF);
        _commitBar.text = @"完成";
