...
- (void)initToolBar {
    self.toolBar = [[MOFSToolView alloc] initWithFrame:CGRectMake(0, 0, UISCREEN_WIDTH, 50)];
    self.toolBar.backgroundColor = [UIColor whiteColor];
    [UIView huz_bezierPathWithRoundedRect:self.toolBar];
}
...
- (void)initBgView {
    self.bgView = [[UIView alloc] initWithFrame:CGRectMake(0, UISCREEN_HEIGHT - self.frame.size.height - 50, UISCREEN_WIDTH, self.frame.size.height + self.toolBar.frame.size.height)];
}
