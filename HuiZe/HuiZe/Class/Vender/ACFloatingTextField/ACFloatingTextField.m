...
-(void)initialization{
    ...
    if (_placeHolderColor == nil){
        _placeHolderColor = [UIColor colorWithRed:200/256.0 green:200/256.0 blue:200/256.0 alpha:1.0];
    }
    
    //2. Placeholder Color When Selected.
    if (_selectedPlaceHolderColor==nil) {
        _selectedPlaceHolderColor = [UIColor colorWithRed:200/256.0 green:200/256.0 blue:200/256.0 alpha:1.0];
    }
    
    //3. Bottom line Color.
    if (_lineColor==nil) {
        _lineColor = [UIColor colorWithRed:200/256.0 green:200/256.0 blue:200/256.0 alpha:1.0];
    }
...
//    [self setValue:self.placeHolderColor forKeyPath:@"_placeholderLabel.textColor"];
    ...
    self.attributedPlaceholder = [self withPlaceHolderAttributedTextColor:self.placeHolderColor];
...
-(NSAttributedString *)withPlaceHolderAttributedTextColor:(UIColor *)color {
    
    if (!self.placeholder) {
        if ([self.placeholder removeStringSpace].length == 0) {
...
-(void)floatPlaceHolder:(BOOL)selected {
    ...
    if (selected) {
        ...
        self.attributedPlaceholder = [self withPlaceHolderAttributedTextColor:self.selectedPlaceHolderColor];
    }
    else{
