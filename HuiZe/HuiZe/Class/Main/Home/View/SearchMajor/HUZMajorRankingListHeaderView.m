//
//  HUZMajorRankingListHeaderView.m
//  HuiZe
//
...
@implementation HUZMajorRankingListHeaderView
...
- (void)initView{
    ...
    [self.btnBatch mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_offset(AutoDistance(12));
    ...
    [self.btnBatch jk_setImagePosition:LXMImagePositionRight spacing:0];
